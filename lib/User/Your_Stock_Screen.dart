...
class YourStockScreen extends StatefulWidget {
  const YourStockScreen({super.key});

  @override
  State<YourStockScreen> createState() => _YourStockScreenState();
}

class _YourStockScreenState extends State<YourStockScreen> {
  FirebaseFirestore firestore = FirebaseFirestore.instance;
  FirebaseAuth auth = FirebaseAuth.instance;
