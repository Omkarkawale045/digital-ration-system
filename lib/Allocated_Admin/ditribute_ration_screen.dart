...
class DistributeRationScreen extends StatefulWidget {
  @override
  _DistributeRationScreenState createState() => _DistributeRationScreenState();
}

class _DistributeRationScreenState extends State<DistributeRationScreen> {
  ...
  void _addStockToAdmin() async {
    ...
    try {
      ...
      await firestore.collection('distributions').add({
